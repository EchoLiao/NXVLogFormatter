#
#  Be sure to run `pod spec lint NXVLogFormatter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors          = { "Vinh Nguyen" => "vinhnguyen2308@gmail.com", "other author" => "email@address.com" }
  # s.author           = 'Vinh Nguyen', 'other author'
  ...
  s.source       = { :git => "https://github.com/vinhnx/NXVLogFormatter.git", :tag => "0.0.1" }
  ...
  s.source_files  = 'NXVLogFormatter', 'NXVLogFormatter/*.{h,m}'
